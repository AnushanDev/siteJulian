      ...
      <div className='flex justify-center mt-12'>
        <div className="flex">
          <div className="flex justify-start lg:flex-row flex-col">
            <div className="lg:w-1/2 text-black px-10 lg:text-lg  text-base relative font-avenir text-justify">
            ...
            <div className="lg:w-1/2 text-black lg:text-white px-10 md:text-lg text-base lg:py-0 pt-10 pb-20 relative font-avenir text-justify flex items-end">
              <p className='leading-[1.3]'><span className='md:text-2xl text-lg font-bold font-helvetica md:pb-0'>JULIAN AGUILAR</span><br />16.11.1998<br />SUISEE - ESPAGNOL<br />FROM GENEVA</p>
            </div>
          </div>
        </div>
      </div>
